...
function recenterMapContinuously() {
  ...
  const intervalDuration = 1000; // Update every 1 seconds (adjust as needed)
...
// Call the recenterMapContinuously function to start recentering the map
recenterMapContinuously();