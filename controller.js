...
function continuouslyRecenterMap(userLocation, trackUser) {
  if (trackUser) {
    map.flyTo({
      center: userLocation,
      essential: true
  ...
  continuouslyRecenterMap(userLocation, trackUser); // Call the function to continuously recenter the map
  setRouteFromStartToEnd(userLocation, chosenDestination); // Update this line
  map.flyTo({
    center: userLocation,
    zoom: 22,
