...
// Update the marker's position along the route
function updateMarkerAlongRoute(coordinate) {
  // Ensure el is defined
  const el = document.createElement('div');
  el.className = 'marker';
  el.className = 'custom-marker'; // Assign a custom class
  el.style.backgroundImage = 'url(https://www.shutterstock.com/image-photo/guy-cant-hold-anymore-need-260nw-1555571621.jpg)'; // Set the custom image
...
// Set route from start to end point
